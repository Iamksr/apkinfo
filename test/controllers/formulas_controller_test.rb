...
class FormulasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create formula" do
    assert_difference('Formula.count') do
      post formulas_url, params: { formula: { description: @formula.description, name: @formula.name, title: @formula.title } }
    end
  ...
  test "should update formula" do
    patch formula_url(@formula), params: { formula: { description: @formula.description, name: @formula.name, title: @formula.title } }
